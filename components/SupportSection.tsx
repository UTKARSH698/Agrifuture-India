...
export const SupportSection: React.FC = () => {
  return (
    <section className="py-24 px-6 relative overflow-hidden border-t border-black/5 dark:border-white/5 bg-gradient-to-b from-transparent to-black/5 dark:to-white/5">
